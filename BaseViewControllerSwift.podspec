...
Pod::Spec.new do |s|
  s.name             = 'MTBaseViewControllerSwift'
  s.version          = '1.0.8'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'git@github.com:MateenHJL/MTBaseViewControllerSwift.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '13162378587@163.com' => '13162378587@163.com' }
  s.source           = { :git => 'git@github.com:MateenHJL/MTBaseViewControllerSwift.git', :tag => s.version.to_s }
